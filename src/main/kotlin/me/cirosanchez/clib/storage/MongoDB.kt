...
import me.cirosanchez.clib.storage.MongoDB.executor
import me.cirosanchez.clib.toJson
...
object MongoDB {
    ...
    class Settings {
        var uri: String = CLib.get().mongoURI
        var database: String = CLib.get().mongoDB
    }
